        ...
        <div class="content-body">
            <div class="container mt-4" style="max-width: 720px;">
                <div class="card mb-4 shadow-sm">
                    <div class="card-body">
                        <h3 class="mb-3" style="font-weight: 600;">Petty Cash Entries</h3>
                ...
                <div class="mb-2 px-2">
                    <span class="fw-bold" style="font-size: 1rem;">Total In:</span> Rs. <b>{{ number_format($totalIn,2) }}</b>
                    &nbsp;
                    <span class="fw-bold" style="font-size: 1rem;">Total Out:</span> Rs. <b>{{ number_format($totalOut,2) }}</b>
                    &nbsp;
                    <span class="fw-bold" style="font-size: 1rem;">Balance:</span> Rs. <b>{{ number_format($balance,2) }}</b>
                </div>
